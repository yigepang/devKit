 ...
 */
public class LabelViewLayout extends ViewGroup implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.LabelViewLayout);
            int type = mTypedArray.getInt(R.styleable.LabelViewLayout_selectType, 1);
            mSelectType = SelectType.get(type);

            mMaxSelect = mTypedArray.getInteger(R.styleable.LabelViewLayout_maxSelect, 0);
            mMinSelect = mTypedArray.getInteger(R.styleable.LabelViewLayout_minSelect, 0);
            mMaxLines = mTypedArray.getInteger(R.styleable.LabelViewLayout_maxLines, 0);
            mMaxColumns = mTypedArray.getInteger(R.styleable.LabelViewLayout_maxColumns, 0);
            isIndicator = mTypedArray.getBoolean(R.styleable.LabelViewLayout_isIndicator, false);

            mLabelGravity = mTypedArray.getInt(R.styleable.LabelViewLayout_labelGravity, mLabelGravity);
            mLabelWidth = mTypedArray.getLayoutDimension(R.styleable.LabelViewLayout_labelTextWidth, mLabelWidth);
            mLabelHeight = mTypedArray.getLayoutDimension(R.styleable.LabelViewLayout_labelTextHeight, mLabelHeight);

            if (mTypedArray.hasValue(R.styleable.LabelViewLayout_labelTextColor)) {
                mTextColor = mTypedArray.getColorStateList(R.styleable.LabelViewLayout_labelTextColor);
            } else {
                mTextColor = ColorStateList.valueOf(0xFF000000);
            }

            mTextSize = mTypedArray.getDimension(R.styleable.LabelViewLayout_labelTextSize,
                    sp2px(14));
            if (mTypedArray.hasValue(R.styleable.LabelViewLayout_labelTextPadding)) {
                int textPadding = mTypedArray.getDimensionPixelOffset(
                        R.styleable.LabelViewLayout_labelTextPadding, 0);
                ...
                mTextPaddingLeft = mTypedArray.getDimensionPixelOffset(
                        R.styleable.LabelViewLayout_labelTextPaddingLeft, dp2px(10));
                mTextPaddingTop = mTypedArray.getDimensionPixelOffset(
                        R.styleable.LabelViewLayout_labelTextPaddingTop, dp2px(5));
                mTextPaddingRight = mTypedArray.getDimensionPixelOffset(
                        R.styleable.LabelViewLayout_labelTextPaddingRight, dp2px(10));
                mTextPaddingBottom = mTypedArray.getDimensionPixelOffset(
                        R.styleable.LabelViewLayout_labelTextPaddingBottom, dp2px(5));
            }

            mLineMargin = mTypedArray.getDimensionPixelOffset(R.styleable.LabelViewLayout_lineMargin, dp2px(5));
            mWordMargin = mTypedArray.getDimensionPixelOffset(R.styleable.LabelViewLayout_wordMargin, dp2px(5));
            if (mTypedArray.hasValue(R.styleable.LabelViewLayout_labelBackground)) {
                int labelBgResId = mTypedArray.getResourceId(R.styleable.LabelViewLayout_labelBackground, 0);
                if (labelBgResId != 0) {
                    mLabelBg = getResources().getDrawable(labelBgResId);
                } else {
                    int labelBgColor = mTypedArray.getColor(R.styleable.LabelViewLayout_labelBackground, Color.TRANSPARENT);
            ...
            isSingleLine = mTypedArray.getBoolean(R.styleable.LabelViewLayout_singleLine, false);
            isTextBold = mTypedArray.getBoolean(R.styleable.LabelViewLayout_isTextBold, false);
