...
/**
 * 由hoozy于2023/3/10 17:49进行创建
 * 描述：
 */
public class CircleJumpProgressbar extends AppCompatTextView {
    //外部轮廓的颜色
    ...
    public CircleJumpProgressbar(Context context) {
        this(context, null);
    }

    public CircleJumpProgressbar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleJumpProgressbar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.CircleJumpProgressbar);
        if (typedArray.hasValue(R.styleable.CircleJumpProgressbar_in_circle_color))
            inCircleColors = typedArray.getColorStateList(R.styleable.CircleJumpProgressbar_in_circle_color);
        else
