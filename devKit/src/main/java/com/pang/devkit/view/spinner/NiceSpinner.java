...
public class NiceSpinner extends AppCompatTextView {
    ...
    private boolean showSelectItemEnable;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        popTextSize = typedArray.getInt(R.styleable.NiceSpinner_popTextSize, 14);
        ...
        popupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!showSelectItemEnable && position >= selectedIndex && position < adapter.getCount()) {
                    position++;
                }
        ...
        showSelectItemEnable = typedArray.getBoolean(R.styleable.NiceSpinner_showSelectItemEnable, false);
    ...
    public <T> void attachDataSource(@NonNull List<T> list) {
        if (showSelectItemEnable) {
            adapter = new NiceSpinnerShowSelectAdapter(getContext(), list, textColor, backgroundSelector, spinnerTextFormatter, horizontalAlignment, popTextSize);
        } else {
            adapter = new NiceSpinnerAdapter<>(getContext(), list, textColor, backgroundSelector, spinnerTextFormatter, horizontalAlignment, popTextSize);
        }
    ...
    public void setAdapter(ListAdapter adapter) {
        if (showSelectItemEnable) {
            this.adapter = new NiceSpinnerShowSelectAdapterWrapper(getContext(), adapter, textColor, backgroundSelector,
                    spinnerTextFormatter, horizontalAlignment, popTextSize);
        } else {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (isEnabled() && event.getAction() == MotionEvent.ACTION_UP) {
            if (!popupWindow.isShowing() && null != adapter && adapter.getCount() > 0) {
                showDropDown();
            } else {
                dismissDropDown();
            }
    ...
    public void setPopTextSize(int popTextSize) {
