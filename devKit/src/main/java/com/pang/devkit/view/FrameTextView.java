...
public class FrameTextView extends LinearLayout {
    ...
    public FrameTextView(Context context, @Nullable AttributeSet attrs) {
        ...
        leftTextSize = typedArray.getInteger(R.styleable.ShowAndInputTextView_leftTextSize, 13);
        rightTextSize = typedArray.getInteger(R.styleable.ShowAndInputTextView_rightTextSize, 13);
        rightEditTextSize = typedArray.getInteger(R.styleable.ShowAndInputTextView_rightEditSize, 13);
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_frame_item, this, false);
