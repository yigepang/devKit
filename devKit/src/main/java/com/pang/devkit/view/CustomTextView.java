...
public class CustomTextView extends AppCompatTextView {
    ...
    public CustomTextView(Context context, AttributeSet set) {
        ...
        float textsize = typedArray.getDimension(R.styleable.CYTextView_textSizeCustomTextView, 34);
        int textcolor = typedArray.getColor(R.styleable.CYTextView_textColorCustomTextView, getResources().getColor(R.color.white));
        float linespace = typedArray.getDimension(R.styleable.CYTextView_lineSpacingExtra, 15);
        int typeface = typedArray.getColor(R.styleable.CYTextView_typefaceCustomTextView, 0);
