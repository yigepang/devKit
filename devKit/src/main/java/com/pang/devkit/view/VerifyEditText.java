...
public class VerifyEditText extends LinearLayout {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        final int passwordVisibleTime = obtainStyledAttributes.getInt(R.styleable.verify_EditText_verify_password_visible_time, DEFAULT_PASSWORD_VISIBLE_TIME);
        ...
        final boolean password = obtainStyledAttributes.getBoolean(R.styleable.verify_EditText_verify_password, false);
