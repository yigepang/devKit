...
/**
 * Created by hoozy on 2022/4/9
 * Describe:
 * AnnularChartView.setColors(new int[]{Color.parseColor("#177EE5"), Color.parseColor("#7DDBEF")});
 * float[] ff = new float[2];
 * ff[1] = Float.parseFloat("" + allAmount);传入float类型，因为百分比计算含小数
 * AnnularChartView.setData(ff);
 */
public class AnnularChartView extends View {
    ...
    private void initRectF(int w, int h) {
        ...
        oval = new RectF(centerX - innerRadius, centerY - innerRadius,
