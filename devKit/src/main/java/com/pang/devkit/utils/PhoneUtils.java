...
import static com.pang.devkit.utils.simulutil.CheckResult.RESULT_EMULATOR;
import static com.pang.devkit.utils.simulutil.CheckResult.RESULT_MAYBE_EMULATOR;
import static com.pang.devkit.utils.simulutil.CheckResult.RESULT_UNKNOWN;
...
import com.pang.devkit.utils.simulutil.CheckResult;
import com.pang.devkit.utils.simulutil.CommandUtil;
import com.pang.devkit.utils.simulutil.EmulatorCheckCallback;


/**
 * 由hoozy于2023/7/4 09:06进行创建
 * 描述：
 */
public class PhoneUtils {
    ...
    public static final PhoneUtils getSingleInstance() {
    ...
    public boolean readSysProperty(Context context, EmulatorCheckCallback callback) {
        ...
        //嫌疑值大于等于3，认为是模拟器      *目前测出华为平板和雷电模拟器为3*
