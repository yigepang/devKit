...
/**
 * 由hoozy于2024/1/3 15:34进行创建
 * 描述：
 */
public class CheckSimulator {
    private static String TAG = "EmulatorCheckUtil:";

    private CheckSimulator() {

    }

    private static class SingletonHolder {
        private static final CheckSimulator INSTANCE = new CheckSimulator();
    }

    public static final CheckSimulator getSingleInstance() {
